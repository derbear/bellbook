<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->book_id), array('buy/browse', 'bookid'=>$data->book_id)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sellOffers')); ?>:</b>
	<?php echo CHtml::encode(count($data->sellOffers)); ?>
	<br />

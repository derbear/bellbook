...
return array(
	...
	// direct user to the correct part of the site (logged in, not logged in)
	...
	'import'=>array(
		...
		'application.components.basic controllers.*',
	),
	...
	'components'=>array(
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=bellbookyii',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
